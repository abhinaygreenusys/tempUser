...
const DairyEggs = () => {
  ...
  const productList = [
    {
      name: 'MotherDairy Toned Milky Milk',
    ...
    {
      name: 'MotherDairy Taza Whole Milk',
      image: 'assets/motherdairy3.png',
      price: 300,
      quantity: '1L',
    },
    {
      name: 'MotherDairy Skimmed Milk',
    ...
    {
      name: ' MotherDairy Full Cream Milk',
      image: 'assets/motherdairy1.png',
      price: 235,
      originalPrice: 260,
      discount: '5% OFF',
      quantity: '500 ml',
  ...
  const handleButtonClick = (buttonName) => {
    ...
    if (buttonName === 'Amul') {navigate('/amul-products');}
    if (buttonName === 'Mother Dairy') {navigate('/mother-dairy');}
  };
          ...
          <div className="content">
              ...
              <div className="product-row">
                {currentProducts.map((product, index) => (
                  <div key={index} className="product-box">
                    ...
                    <img src={product.image} alt={product.name} className="dairy-product-image" onClick={() => handleProductClick(product.name)} />
            ...
            <div className="pagination">
              ...
              {Array.from({ length: totalPages }, (_, i) => (
                <button key={i + 1} className={`page-button ${currentPage === i + 1 ? 'active' : ''}`} onClick={() => handlePageChange(i + 1)}>
                  {i + 1}
                </button>
              ))}
