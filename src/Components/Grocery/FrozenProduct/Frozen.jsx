...
import FrozenSidebar from './FrozenSidebar';
...
const Frozen = () => {
  ...
  const productList = [
    ...
    {
      name: 'Healthy Breakfast for Morning',
      image: 'assets/frozen.png',
      price: 500,
      quantity: '500 gm',
    },
    {
      name: 'Diet Breakfast for Morning',
      image: 'assets/frozen.png',
      price: 200,
      originalPrice: 190,
      discount: '5% OFF',
  ...
  const handleIncreaseQuantity = (product) => {updateCartItemQuantity(product, 1);};
  const handleDecreaseQuantity = (product) => {updateCartItemQuantity(product, -1);};
  const handleProductClick = (productName) => {if (productName === 'Amul Taza Toned Milky Milk') {navigate('/amul2-product-description');}};
