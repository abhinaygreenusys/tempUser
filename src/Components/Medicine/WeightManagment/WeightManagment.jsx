...
import WeightManagmentSidebar from './WeightManagmentSidebar';

const WeightManagment = () => {
  ...
  const productList = [
    {
      ...
      image: 'assets/weightmanagment.png',
      price: 235,
      originalPrice: 260,
      discount: '5% OFF',
      quantity: '125 ml',
    ...
    <div className="medicine-page">
      ...
      <div className="dairy-eggs-body">
        <div className="breadcrumb">
          <p>Home / Medicine / Weight Managment</p>
        </div>
        <hr className="black-line" />
        <div className="content-wrapper">
          <WeightManagmentSidebar />
          <div className="content">
            <div className="left-section">
              <h2>Weight Loss Medication</h2>
...
export default WeightManagment;
