...
import HealthEquipmentSidebar from './HealthEquipmentSidebar';

const HealthEquipment = () => {
    ...
    <div className="medicine-page">
      ...
      <div className="dairy-eggs-body">
        <div className="breadcrumb">
          <p>Home / Medicine / Health Device</p>
        </div>
        <hr className="black-line" />
        <div className="content-wrapper">
          <HealthEquipmentSidebar />
          <div className="content">
            <div className="left-section">
              <h2>Health Device Equipments</h2>
...
export default HealthEquipment;
